...
class Board {
    ...
    for (let i = 0; i < 8; i++) {
      for (let j = 0; j < 8; j++) {
        if (document.getElementById(String(i) + String(j) + "d")) {
          document
            .getElementById(String(i) + String(j) + "d")
  ...
  movemove() {
    ...
    if (
      ...
      this.allowed == this.Feld[Temp1][Temp2].color
    ) {
        ...
        if (!this.Tempispin) {
          ...
          if (moves[Tempmove5][2] != undefined) {
            ...
            if (moves[Tempmove5][4] != undefined) {
              if (this.allowed == "W") {
                this.Feld[moves[Tempmove5][4]][moves[Tempmove5][5]] = new Rook(
                  moves[Tempmove5][5],
                  moves[Tempmove5][4],
                  "W",
                  "/img/Rook_White.png"
              ...
              this.Feld[moves[Tempmove5][4]][moves[Tempmove5][5]].change(
                moves[Tempmove5][5],
                moves[Tempmove5][4]
              );
            }
  ...
  isPinned(Temp1, Temp2, Temp3, Temp4, Figur, moves, Temp5, Tempmove5) {
    ...
    if (moves[Tempmove5][2] != undefined) {
      ...
      if (moves[Tempmove5][4] != undefined) {
        if (this.allowed == "W") {
          this.testFeld[moves[Tempmove5][4]][moves[Tempmove5][5]] = new Rook(
            moves[Tempmove5][5],
            moves[Tempmove5][4],
            "W",
            "/img/Rook_White.png"
        ...
        this.testFeld[moves[Tempmove5][4]][moves[Tempmove5][5]].change(
          moves[Tempmove5][5],
          moves[Tempmove5][4]
        );
      }
        ...
        if (this.testFeld[allmoves[z][0]][allmoves[z][1]] != undefined) {
          ...
          if (allmoves[z][2] != undefined) {
            ...
            if (allmoves[z][4] != undefined) {
              if (this.allowed == "W") {
                this.testFeld[allmoves[z][4]][allmoves[z][5]] = new Rook(
                  allmoves[z][5],
                  allmoves[z][4],
                  "W",
                  "/img/Rook_White.png"
              ...
              this.testFeld[allmoves[z][4]][allmoves[z][5]].change(
                allmoves[z][5],
                allmoves[z][4]
              );
            }
  ...
  render() {
      ...
      for (let j = 0; j < 8; j++) {
        if (this.Feld[i][j].name != undefined) {
          if (this.Feld[i][j].color == "W") {
            document.getElementById(String(i) + String(j)).innerHTML =
              "<div class='light drag' draggable='true' id='" +
              String(i) +
              String(j) +
              "d'><img src='" +
              this.Feld[i][j].img +
            ...
            document.getElementById(String(i) + String(j)).innerHTML =
              "<div class='dark drag' draggable='true' id='" +
              String(i) +
              String(j) +
              "d'><img src='" +
              this.Feld[i][j].img +
    ...
    for (let i = 0; i < this.moves.length / 2; i++) {
      ...
      teil.innerHTML =
        buchstaben[Temp2] + Temp1 + "" + buchstaben[Temp4] + Temp3;
      if (this.moves[i + 1]) {
